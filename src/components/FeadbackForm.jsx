      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="AboutSection" className="hover:text-blue-500 transition">About Us</a></li>
              <li><a href="#ProcessSection" className="hover:text-blue-500 transition">Features</a></li>
              <li><a href="/blog" className="hover:text-blue-500 transition">Blog</a></li>
              <li><a href="/chatbot" className="hover:text-blue-500 transition">Chat bot</a></li>
            </ul>
          </div>
          </Reveal>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>INDERPRASTHA ENGINEERING COLLEGE</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:support@hydroloop.com" className="hover:text-blue-500 transition">niveshjain213@gmail.com</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-blue-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
                <a href="tel:+11234567890" className="hover:text-blue-500 transition">+91 9119734890</a>
              </li>
            </ul>
          </div>
          </Reveal>
        ...
        <Reveal direction="up">
          <div className="pt-8 border-t border-slate-700 text-center text-gray-400 text-sm">
            © 2025 HydroLoop. Made by Nivesh Jain, Pawas Gupta, Pappu Yadav.
          </div>
        </Reveal>
      </div>
      </footer>
