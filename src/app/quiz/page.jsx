      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 m-2 bg-white rounded-full flex items-center justify-center">
              <img
                src="/image/logo.png"
                alt="HydroLoop Logo"
                width={55}
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                {currentQuestion.options.map((option, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-4 p-4 rounded-lg border-2 transition-all text-left ${isSelected
                          ? wasAnswered
                            ? isCorrect
                              ? 'border-green-500 bg-green-50'
                              : 'border-red-500 bg-red-50'
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                <button
                  ...
                  className={`px-8 py-3 rounded-lg font-semibold transition-colors ${selectedAnswer === null || wasAnswered
                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className={`px-6 py-2 rounded-lg font-semibold transition-colors flex items-center gap-2 ${currentQuestionIndex === selectedQuestions.length - 1 || !wasAnswered
                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        : 'bg-gray-200 hover:bg-gray-300 text-gray-700'
                      }`}
                  >
                  ...
                  {selectedQuestions.map((question, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-2 rounded text-sm transition-colors ${isCurrent
